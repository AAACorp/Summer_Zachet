...
public class DoorController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInZone)
        {
            ...
            {
                txtToDisplay.GetComponent<Text>().text = "Нажмите 'E', чтобы закрыть";
                doorCollider.enabled = false;
            }
            else if (doorState == DoorState.Closed || gotKey)
            {
                txtToDisplay.GetComponent<Text>().text = "Нажмите 'E', чтобы открыть";
                doorCollider.enabled = true;
            }
            else if (doorState == DoorState.Jammed)
            {
                txtToDisplay.GetComponent<Text>().text = "Нужен ключ";
                doorCollider.enabled = true;
            }
        }
